...
public class ParkingLotGrid 
{
	...
	private Range[] xRange = {  new Range(195, 218), new Range(224, 258),new Range(262, 301),new Range(299, 341),new Range(387, 412),new Range(425, 455),
								new Range(455, 487), new Range(484, 528),new Range(520, 550),new Range(191, 232),new Range(250, 275),new Range(279, 328),
	...
	//Copied values starting at 1 :6->7,8,9,10
	private Scalar[] lowerArray = {
			...
			new Scalar(0,0,70), new Scalar(0,0,70), new Scalar(0,0,70), new Scalar(0,0,70), new Scalar(0,0,50), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0)};
	...
	private Scalar[] upperArray = {
			...
			new Scalar(140,20,130), new Scalar(140,20,130), new Scalar(140,20,130), new Scalar(140,20,130), new Scalar(150,30,85), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), 
			new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0)};
